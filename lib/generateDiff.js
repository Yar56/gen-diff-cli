  ...
  const iter = (key, value1, value2) => {
    ...
    if (property1 && property2) {
      if (!_.isObject(keyValue1) && !_.isObject(keyValue2)) {
        ...
        const value = nodeType === 'unchanged' ? { keyValue1 } : { keyValue1, keyValue2 };
        return { key, value, nodeType };
      }
      const children = generateDiff(keyValue1, keyValue2);
      const value = _.isObject(keyValue1) && _.isObject(keyValue2) ? null : keyValue1;
      return {
        key,
        children,
        value,
    ...
    if (!property1 && property2) {
      if (!_.isObject(keyValue1) && !_.isObject(keyValue2)) {
        return { key, value: { keyValue2 }, nodeType: 'added' };
      }
    ...
    if (property1 && !property2) {
      if (!_.isObject(keyValue1) && !_.isObject(keyValue2)) {
        return { key, value: { keyValue1 }, nodeType: 'removed' };
      }
